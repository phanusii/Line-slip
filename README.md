...
ระบบอ่าน QR บนรูปสลิปด้วย `jsQR` และอ่านยอดด้วย `tesseract.js` บนเซิร์ฟเวอร์ของตัวเองเพื่อช่วยกันสลิปวนซ้ำและตรวจยอดแบบฟรี 100% โดย auto verify จะผ่านเฉพาะเงื่อนไขเข้มสุด เช่น LINE user ตรง, QR/รูปไม่ซ้ำ, OCR ยอดตรง และยอดไม่ซ้ำในงาน
