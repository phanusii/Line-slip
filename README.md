...
ระบบนี้ไม่เรียก API ตรวจสลิปแบบเสียเงิน สลิปใหม่จะถูกบันทึกเป็น `manual_review` เพื่อให้ผู้ดูแลเปิดดูและอนุมัติ/ปฏิเสธเอง ส่วนสลิปที่รูปซ้ำจะถูกบันทึกเป็น `duplicate_slip`
...
- ตั้งค่า Telegram หรือ Discord ได้จากหน้า `ตั้งค่า LINE` เพื่อส่งสลิปใหม่ให้แอดมินตรวจผ่าน signed action link
